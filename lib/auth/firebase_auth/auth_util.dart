...
DocumentReference? get currentUserReference =>
    loggedIn ? UserProfileRecord.collection.doc(currentUser!.uid) : null;

UserProfileRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserProfileRecord.getDocument(UserProfileRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
