                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'mknjg0kq' /* (managed by the Miggy team) */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.inter(
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'hx5lug72' /* For technical or other issues,... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.inter(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                '58p2x2mw' /* Sed orci erat, sagittis id sus... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'eppif1sc' /* Phasellus: non cong. Orbi eu s... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            FlutterFlowDropDown<String>(
                              controller:
                                  _model.issueCategoryValueController ??=
                            ...
                            Container(
                              width: double.infinity,
                              child: TextFormField(
                                controller: _model.textMessageTextController,
