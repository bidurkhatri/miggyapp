...
class SearchUsersWidget extends StatefulWidget {
  ...
  static String routeName = 'search_users';
  static String routePath = '/searchUsers';
                    ...
                    Flexible(
                      child: StreamBuilder<List<UserProfileRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<UserProfileRecord> defaulTUserProfileRecordList =
                              snapshot.data!;
                          if (defaulTUserProfileRecordList.isEmpty) {
                          ...
                          return ListView.separated(
                            ...
                            itemCount: defaulTUserProfileRecordList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 15.0),
                            itemBuilder: (context, defaulTIndex) {
                              final defaulTUserProfileRecord =
                                  defaulTUserProfileRecordList[defaulTIndex];
                              return Container(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              defaulTUserProfileRecord.fullName,
                                              style:
                                            ...
                                            Text(
                                              valueOrDefault<String>(
                                                'Lvl ${defaulTUserProfileRecord.levelling.toString()}, ${defaulTUserProfileRecord.country}',
                                                'Lvl 21, Nigeria',
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                      ...
                                      if (!(currentUserDocument?.following
                                                  .toList() ??
                                              [])
                                          .contains(defaulTUserProfileRecord
                                              .reference))
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            valueOrDefault<String>(
                                              'Lvl ${searchResultItem.levelling.toString()}, ${searchResultItem.country}',
                                              'Lvl 21, Nigeria',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
