...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SearchUsersWidget.routeName,
          path: SearchUsersWidget.routePath,
          builder: (context, params) => SearchUsersWidget(),
        ),
        FFRoute(
          name: AccountBalanceWidget.routeName,
          path: AccountBalanceWidget.routePath,
          builder: (context, params) => AccountBalanceWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AuthorizedPeopleWidget.routeName,
          path: AuthorizedPeopleWidget.routePath,
          builder: (context, params) => AuthorizedPeopleWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AchievementReportWidget.routeName,
          path: AchievementReportWidget.routePath,
          builder: (context, params) => AchievementReportWidget(),
        ),
        FFRoute(
          name: WorldMiggyWidget.routeName,
          path: WorldMiggyWidget.routePath,
          builder: (context, params) => WorldMiggyWidget(),
        ),
        FFRoute(
          name: CommandsWidget.routeName,
          path: CommandsWidget.routePath,
          builder: (context, params) => CommandsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: LeaderboardsWidget.routeName,
          path: LeaderboardsWidget.routePath,
          builder: (context, params) => LeaderboardsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: StoreEmoteWidget.routeName,
          path: StoreEmoteWidget.routePath,
          builder: (context, params) => StoreEmoteWidget(),
        ),
        FFRoute(
          name: GiftsStoreWidget.routeName,
          path: GiftsStoreWidget.routePath,
          builder: (context, params) => GiftsStoreWidget(),
        ),
        FFRoute(
          name: BeMerchantWidget.routeName,
          path: BeMerchantWidget.routePath,
          builder: (context, params) => BeMerchantWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: GameWidget.routePath,
          asyncParams: {
            'gameRoom': getDoc(['rooms'], RoomsRecord.fromSnapshot),
          },
          builder: (context, params) => GameWidget(
            gameRoom: params.getParam(
              'gameRoom',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          asyncParams: {
            'userDoc': getDoc(['user_profile'], UserProfileRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          asyncParams: {
            'postRef': getDoc(['posts'], PostsRecord.fromSnapshot),
            'userDoc': getDoc(['user_profile'], UserProfileRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: JibefkrWidget.routeName,
          path: JibefkrWidget.routePath,
          builder: (context, params) => JibefkrWidget(),
        )
